...
echo '</head>';
printf( '<body class="login no-js login-action-password wp-core-ui admin-color-modern %s">', esc_attr( 'locale-' . sanitize_html_class( strtolower( str_replace( '_', '-', get_locale() ) ) ) ) );
